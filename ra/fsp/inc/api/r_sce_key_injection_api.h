...
/* For RSA operation. */
#define R_SCE_RSA_2048_KEY_N_LENGTH_BYTE_SIZE                    (HW_SCE_RSA_2048_KEY_N_LENGTH_BYTE_SIZE)
#define R_SCE_RSA_3072_KEY_N_LENGTH_BYTE_SIZE                    (HW_SCE_RSA_3072_KEY_N_LENGTH_BYTE_SIZE)
#define R_SCE_RSA_4096_KEY_N_LENGTH_BYTE_SIZE                    (HW_SCE_RSA_4096_KEY_N_LENGTH_BYTE_SIZE)
#define R_SCE_RSA_2048_KEY_E_LENGTH_BYTE_SIZE                    (HW_SCE_RSA_2048_KEY_E_LENGTH_BYTE_SIZE)
#define R_SCE_RSA_3072_KEY_E_LENGTH_BYTE_SIZE                    (HW_SCE_RSA_3072_KEY_E_LENGTH_BYTE_SIZE)
#define R_SCE_RSA_4096_KEY_E_LENGTH_BYTE_SIZE                    (HW_SCE_RSA_4096_KEY_E_LENGTH_BYTE_SIZE)
#define R_SCE_RSA_2048_KEY_D_LENGTH_BYTE_SIZE                    (HW_SCE_RSA_2048_KEY_D_LENGTH_BYTE_SIZE)
#define R_SCE_RSA_KEY_GENERATION_DUMMY_BYTE_SIZE                 (HW_SCE_RSA_KEY_GENERATION_DUMMY_BYTE_SIZE)
#define R_SCE_RSA_2048_PUBLIC_KEY_MANAGEMENT_INFO1_WORD_SIZE     (HW_SCE_RSA_2048_PUBLIC_KEY_MANAGEMENT_INFO1_WORD_SIZE)
#define R_SCE_RSA_3072_PUBLIC_KEY_MANAGEMENT_INFO1_WORD_SIZE     (HW_SCE_RSA_3072_PUBLIC_KEY_MANAGEMENT_INFO1_WORD_SIZE)
#define R_SCE_RSA_4096_PUBLIC_KEY_MANAGEMENT_INFO1_WORD_SIZE     (HW_SCE_RSA_4096_PUBLIC_KEY_MANAGEMENT_INFO1_WORD_SIZE)
#define R_SCE_RSA_2048_PUBLIC_KEY_MANAGEMENT_INFO2_WORD_SIZE     (HW_SCE_RSA_2048_PUBLIC_KEY_MANAGEMENT_INFO2_WORD_SIZE)
#define R_SCE_RSA_3072_PUBLIC_KEY_MANAGEMENT_INFO2_WORD_SIZE     (HW_SCE_RSA_3072_PUBLIC_KEY_MANAGEMENT_INFO2_WORD_SIZE)
#define R_SCE_RSA_4096_PUBLIC_KEY_MANAGEMENT_INFO2_WORD_SIZE     (HW_SCE_RSA_4096_PUBLIC_KEY_MANAGEMENT_INFO2_WORD_SIZE)
#define R_SCE_RSA_2048_PRIVATE_KEY_MANAGEMENT_INFO1_WORD_SIZE    (HW_SCE_RSA_2048_PRIVATE_KEY_MANAGEMENT_INFO1_WORD_SIZE)
#define R_SCE_RSA_3072_PRIVATE_KEY_MANAGEMENT_INFO1_WORD_SIZE    (HW_SCE_RSA_3072_PRIVATE_KEY_MANAGEMENT_INFO1_WORD_SIZE)
#define R_SCE_RSA_4096_PRIVATE_KEY_MANAGEMENT_INFO1_WORD_SIZE    (HW_SCE_RSA_4096_PRIVATE_KEY_MANAGEMENT_INFO1_WORD_SIZE)
#define R_SCE_RSA_2048_PRIVATE_KEY_MANAGEMENT_INFO2_WORD_SIZE    (HW_SCE_RSA_2048_PRIVATE_KEY_MANAGEMENT_INFO2_WORD_SIZE)
#define R_SCE_RSA_3072_PRIVATE_KEY_MANAGEMENT_INFO2_WORD_SIZE    (HW_SCE_RSA_3072_PRIVATE_KEY_MANAGEMENT_INFO2_WORD_SIZE)
#define R_SCE_RSA_4096_PRIVATE_KEY_MANAGEMENT_INFO2_WORD_SIZE    (HW_SCE_RSA_4096_PRIVATE_KEY_MANAGEMENT_INFO2_WORD_SIZE)
...
typedef struct sce_rsa2048_private_wrapped_key
{
    ...
    struct
    {
        ...
        uint8_t  key_n[R_SCE_RSA_2048_KEY_N_LENGTH_BYTE_SIZE];
...
typedef struct sce_rsa3072_private_wrapped_key
{
    ...
    struct
    {
        ...
        uint8_t  key_n[R_SCE_RSA_3072_KEY_N_LENGTH_BYTE_SIZE];
...
typedef struct sce_rsa4096_private_wrapped_key
{
    ...
    struct
    {
        ...
        uint8_t  key_n[R_SCE_RSA_4096_KEY_N_LENGTH_BYTE_SIZE];
