...
/** @} */ /* End of group Configuration_of_CMSIS */
 ...
 #include "system.h"                       /*!< R7FA0E303 System                                                          */
...
typedef struct                         /*!< (@ 0x400A1800) R_ADC_D Structure                                          */
{
    ...
    __IM uint8_t  RESERVED;
    __IM uint16_t RESERVED1;
    __IM uint16_t ADCR;                /*!< (@ 0x00000006) A/D Conversion Result Register                             */
    __IM uint16_t RESERVED2[132];
    ...
    union
    {
        ...
        struct
        {
            __IOM uint8_t ADTYP : 2;   /*!< [1..0] Selection of the resolution                                        */
            __IOM uint8_t AWC   : 1;   /*!< [2..2] Specification of the Snooze Mode                                   */
            __IOM uint8_t ADRCK : 1;   /*!< [3..3] Checking the Upper Limit and Lower Limit Conversion Result
                                        *   Values                                                                    */
            uint8_t              : 1;
            __IOM uint8_t ADREFM : 1;  /*!< [5..5] Selection of the '-' Side Reference Voltage of the A/D
                                        *   Converter                                                                 */
            __IOM uint8_t ADREFP : 2;  /*!< [7..6] Selection of the '+' Side Reference Voltage Source of
                                        *   the A/D Converter                                                         */
        } ADM2_b;
    };
