...
{
    r_rsip_func_sub024(0x00008ce0U, 0x00ffffffU, 0x000090e0U, 0x01000000U);

    r_rsip_func_sub029(0x40000000U, 0x30009104U, 0x810100e0U);
    r_rsip_func_sub001(0x00890005U);

    r_rsip_func_sub004(0x08000004U, 0x00000000U);

    r_rsip_func_sub024(0x00008ce0U, 0x00ffffffU, 0x000090e0U, 0x02000000U);

    r_rsip_func_sub029(0x40000000U, 0x30009044U, 0x810100e0U);
    r_rsip_func_sub001(0x00890005U);
