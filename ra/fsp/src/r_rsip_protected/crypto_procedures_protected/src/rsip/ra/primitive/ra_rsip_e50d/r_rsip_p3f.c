...
rsip_ret_t r_rsip_p3f (uint32_t OutData_KeyIndex[])
{
    ...
    r_rsip_func_sub003(0x800103a0U, 0x00003f01U);
    ...
    r_rsip_func_sub003(0x800103a0U, 0x0000003fU);
    ...
    r_rsip_func_sub003(0x800103a0U, 0x00003f02U);
    ...
    r_rsip_func_sub003(0x800103a0U, 0x00003f03U);
    ...
    r_rsip_func_sub003(0x800103a0U, 0x00003f04U);
    ...
    r_rsip_func_sub003(0x800103a0U, 0x00003f05U);
