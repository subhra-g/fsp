                       ...
                       uint32_t       OutData_KeyIndex[])
{
    ...
    r_rsip_func_sub021(0x0000b460U, 0x0000000dU, 0x0000b680U, 0x01b41ce9U);
    ...
    r_rsip_func_sub021(0x0199f119U, 0x00050040U, 0x0000b4c0U, 0x00000001U);

    r_rsip_func_sub021(0x0000b4e0U, 0x00000040U, 0x0000b460U, 0x00000015U);

    r_rsip_func_sub022(0x0000b680U, 0x01b4cab0U, 0x00000080U);
    ...
    else
    {
        ...
        else
        {
            ...
            for (iLoop = 0U; iLoop < S_RAM[0]; iLoop++)
            {
                ...
                r_rsip_func_sub003(0x800103a0U, 0x0000e601U);
            ...
            else
            {
                ...
                r_rsip_func_sub003(0x800103a0U, 0x000000e6U);
                ...
                r_rsip_func_sub003(0x800103a0U, 0x0000e602U);
