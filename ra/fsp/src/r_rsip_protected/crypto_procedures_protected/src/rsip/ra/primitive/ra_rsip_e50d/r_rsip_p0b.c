...
rsip_ret_t r_rsip_p0b (uint32_t OutData_KeyIndex[])
{
    ...
    r_rsip_func_sub003(0x800103a0U, 0x00000b01U);
    ...
    r_rsip_func_sub003(0x800103a0U, 0x0000000bU);
    ...
    r_rsip_func_sub003(0x800103a0U, 0x00000b02U);
    ...
    r_rsip_func_sub003(0x800103a0U, 0x00000b03U);
