...
rsip_ret_t r_rsip_p2b (const uint32_t MAX_CNT, uint32_t OutData_PubKeyIndex[], uint32_t OutData_PrivKeyIndex[])
{
    ...
    r_rsip_func_sub030(0x002b0001U, 0x00000e50U);
    ...
    for (kLoop = 0U; kLoop < MAX_CNT; kLoop++)
    {
        ...
        r_rsip_func_sub026(0x0000b4c0U, 0x00000080U, 0x80b00006U);
        WR1_PROG(REG_1404H, 0x11600000U);
        ...
        r_rsip_func_sub003(0x000000a7U, 0x800103a0U, 0x00002b01U);
        ...
        for (iLoop = 0U; iLoop < 24U; )
        {
            ...
            r_rsip_func_sub003(0x000000a7U, 0x800103a0U, 0x00002b02U);
        ...
        r_rsip_func_sub003(0x000000a7U, 0x800103a0U, 0x00002b03U);
        ...
        r_rsip_func_sub025(0x0000b4c0U, 0x00000080U, 0x0000094aU);
        ...
        else
        {
            ...
            r_rsip_func_sub038(0x00000018U, 0x00000428U, 0x10100010U);
            r_rsip_func_sub007(0x00000838U, 0x00000220U, 0x00000428U);
            WR1_PROG(REG_1020H, 0x00000630U);

            r_rsip_func_sub037(0x10100000U, 0x00010201U);
            ...
            r_rsip_func_sub025(0x0000b560U, 0x00000003U, 0x0000094aU);
            WR1_PROG(REG_1608H, 0x80a0000aU);
            WR1_PROG(REG_1404H, 0x11a00000U);
            r_rsip_func_sub001(0x03430081U);

            r_rsip_func_sub024(0x00000929U, 0x00000908U, 0x0000b4c0U, 0x0000007cU);
            ...
            r_rsip_func_sub033(0x15b00000U, 0x0000094aU, 0x81a0000aU);
            ...
            for (iLoop = 0U; iLoop < S_RAM[0]; iLoop++)
            {
                ...
                r_rsip_func_sub024(0x00000884U, 0x0000b4a0U, 0x00000004U, 0x0000b4c0U);
                r_rsip_func_sub034(0x00000020U, 0x000008e7U, 0x11a00000U);
                for (jLoop = 0U; jLoop < 32U; )
                {
                    ...
                    r_rsip_func_sub003(0x000000a7U, 0x800103a0U, 0x00002b04U);
    ...
    r_rsip_func_sub003(0x000000a7U, 0x800103a0U, 0x00002b05U);
    ...
    r_rsip_func_sub003(0x000000a7U, 0x800103a0U, 0x0000002bU);
    ...
    r_rsip_func_sub038(0x00000018U, 0x00000630U, 0x20200010U);
    ...
    r_rsip_func_sub003(0x000000a7U, 0x800103a0U, 0x00002b06U);
    ...
    r_rsip_func_sub003(0x000000a7U, 0x800103a0U, 0x0000012bU);
    ...
    r_rsip_func_sub024(0x00000884U, 0x0000b4a0U, 0x00000004U, 0x0000b4c0U);
    r_rsip_func_sub034(0x00000040U, 0x000008e7U, 0x15300000U);
    ...
    r_rsip_func_sub024(0x00000884U, 0x0000b4a0U, 0x00000004U, 0x0000b4c0U);
    r_rsip_func_sub034(0x00000040U, 0x000008e7U, 0x13280000U);
    for (iLoop = 0U; iLoop < 64U; )
    {
        WR1_PROG(REG_1600H, 0x34202886U);
        WR1_PROG(REG_1600H, 0x2000d0e0U);
    ...
    r_rsip_func_sub003(0x000000a7U, 0x800103a0U, 0x00002b07U);
    ...
    r_rsip_func_sub003(0x000000a7U, 0x800103a0U, 0x0000022bU);
