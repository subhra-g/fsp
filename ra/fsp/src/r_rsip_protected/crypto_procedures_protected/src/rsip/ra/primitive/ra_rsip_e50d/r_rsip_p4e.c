                       ...
                       uint32_t       OutData_EncSecret[])
{
    ...
    r_rsip_func_sub003(0x800103a0U, 0x00004e01U);
    ...
    else
    {
        ...
        else
        {
            ...
            r_rsip_func_sub003(0x800103a0U, 0x00004e02U);
        ...
        else
        {
            ...
            r_rsip_func_sub003(0x800103a0U, 0x0000004eU);
            ...
            else
            {
                ...
                r_rsip_func_sub003(0x800103a0U, 0x00004e03U);
