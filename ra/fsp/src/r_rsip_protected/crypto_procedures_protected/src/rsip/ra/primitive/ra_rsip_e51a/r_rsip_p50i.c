                        ...
                        const uint32_t InData_IV[])
{
    ...
    r_rsip_func_sub003(0x000000a7U, 0x800103a0U, 0x00005001U);
    ...
    else
    {
        ...
        else if (RD1_MASK(REG_1440H, 0xffffffffU) == 0x00000002U)
        {
            ...
            else
            {
                ...
                r_rsip_func_sub003(0x000000a7U, 0x800103a0U, 0x00005002U);
        ...
        else if (RD1_MASK(REG_1440H, 0xffffffffU) == 0x00000003U)
        {
            ...
            else
            {
                ...
                r_rsip_func_sub003(0x000000a7U, 0x800103a0U, 0x00005003U);
