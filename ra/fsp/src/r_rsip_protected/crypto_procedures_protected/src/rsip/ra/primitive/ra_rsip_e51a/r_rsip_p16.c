...
rsip_ret_t r_rsip_p16 (uint32_t OutData_KeyIndex[])
{
    ...
    r_rsip_func_sub003(0x000000a7U, 0x800103a0U, 0x00001601U);
    ...
    r_rsip_func_sub003(0x000000a7U, 0x800103a0U, 0x00000016U);
    ...
    r_rsip_func_sub003(0x000000a7U, 0x800103a0U, 0x00001602U);
    ...
    r_rsip_func_sub003(0x000000a7U, 0x800103a0U, 0x00001603U);
