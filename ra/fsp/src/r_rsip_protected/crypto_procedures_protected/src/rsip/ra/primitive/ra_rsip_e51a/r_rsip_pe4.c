                       ...
                       uint32_t       OutData_KeyIndex[])
{
    ...
    r_rsip_func_sub024(0x3420a880U, 0x00000003U, 0x2000b480U, 0x00000002U);
    ...
    if (RD1_MASK(REG_1440H, 0xffffffffU) == 0x00000000U)
    {
        ...
        r_rsip_func_sub003(0x000000a7U, 0x800100c0U, 0x00000008U);

        WR1_PROG(REG_1600H, 0x0000b500U);
        WR1_PROG(REG_1600H, 0x01b41ce9U);

        r_rsip_func_sub003(0x000000a7U, 0x80010120U, 0x00000008U);
    ...
    else if (RD1_MASK(REG_1440H, 0xffffffffU) == 0x00000001U)
    {
        ...
        r_rsip_func_sub003(0x000000a7U, 0x800100c0U, 0x0000000cU);

        WR1_PROG(REG_1600H, 0x0000b500U);
        WR1_PROG(REG_1600H, 0x0199f119U);

        r_rsip_func_sub003(0x000000a7U, 0x80010120U, 0x0000000cU);
    ...
    else if (RD1_MASK(REG_1440H, 0xffffffffU) == 0x00000002U)
    {
        ...
        r_rsip_func_sub024(0x30000dceU, 0x00030020U, 0x0000b4a0U, 0x01ea2366U);

        r_rsip_func_sub024(0x0000b4c0U, 0x00000014U, 0x00000060U, 0x0000b4a0U);
        r_rsip_func_sub024(0x015d7825U, 0x0000b4c0U, 0x00000010U, 0x00000080U);
    ...
    r_rsip_func_sub003(0x000000a7U, 0x800103a0U, 0x000000e4U);
    ...
    else
    {
        ...
        else
        {
            ...
            for (iLoop = S_RAM[0]; iLoop < 16U; )
            {
                ...
                r_rsip_func_sub024(0x0000a4e0U, 0x00000004U, 0x0000a4a0U, 0x00000010U);
        ...
        WR1_PROG(REG_1600H, 0x000008a5U);
        r_rsip_func_sub029(0x40000100U, 0xe7009d07U, 0x81900005U);
