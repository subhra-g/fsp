    ...
    else
    {
        ...
        else
        {
            ...
            else
            {
                ...
                r_rsip_func_sub024(0x000034e2U, 0x000568e7U, 0x00026ce7U, 0x00003827U);

                r_rsip_func_sub024(0x0000b4c0U, 0x00000020U, 0x00003402U, 0x00008c00U);
                r_rsip_func_sub024(0x0000001fU, 0x000028c0U, 0x00008cc0U, 0x0000001fU);

                r_rsip_func_sub024(0x00004406U, 0x00007421U, 0x00007821U, 0x00003c27U);

                r_rsip_func_sub024(0x000034c2U, 0x0000a4c0U, 0x0000001fU, 0x000568c6U);

                r_rsip_func_sub025(0x000034e6U, 0x00026ce7U, 0x00000821U);

                for (iLoop = 0U; iLoop < 4U; iLoop++)
                {
                    r_rsip_func_sub024(0x3420a8e0U, 0x0000000dU, 0x10003c27U, 0x1000a4e0U);
