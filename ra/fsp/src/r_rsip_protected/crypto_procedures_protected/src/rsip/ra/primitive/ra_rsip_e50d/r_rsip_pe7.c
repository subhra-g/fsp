        ...
        else
        {
            ...
            for (iLoop = 0U; iLoop < S_RAM[0]; iLoop++)
            {
                ...
                else
                {
                    ...
                    r_rsip_func_sub003(0x800103a0U, 0x0000e701U);
            ...
            {
                r_rsip_func_sub003(0x800103a0U, 0x000000e7U);
                ...
                r_rsip_func_sub003(0x800103a0U, 0x0000e702U);
                ...
                r_rsip_func_sub022(0x00002917U, 0x0000b5e0U, 0x00000080U);
                ...
                else
                {
                    ...
                    if (CHCK_STS(REG_143CH, 22, 1))
                    {
                        ...
                        r_rsip_func_sub022(0x0000b5e0U, 0x00000080U, 0x000008e7U);
