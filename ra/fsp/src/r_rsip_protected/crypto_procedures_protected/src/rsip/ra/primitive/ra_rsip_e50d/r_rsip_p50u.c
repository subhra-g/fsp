...
void r_rsip_p50u (const uint32_t InData_Text[], uint32_t OutData_Text[], uint32_t MAX_CNT)
{
    ...
    if (RD1_MASK(REG_1440H, 0xffffffffU) == 0x00000000U)
    {
        ...
        r_rsip_func_sub025(0x00020061U, 0x40000000U, 0x0a008106U);
    ...
    else if (RD1_MASK(REG_1440H, 0xffffffffU) == 0x00000001U)
    {
        ...
        r_rsip_func_sub025(0x00020061U, 0x40000000U, 0x0a00810eU);
        WR1_PROG(REG_1408H, 0x000c1000U);
    }
    else if (RD1_MASK(REG_1440H, 0xffffffffU) == 0x00000002U)
    {
        ...
        r_rsip_func_sub025(0x00020061U, 0x40000000U, 0x0e008506U);
        WR1_PROG(REG_1408H, 0x000c1000U);
    }
    else if (RD1_MASK(REG_1440H, 0xffffffffU) == 0x00000003U)
    {
        ...
        r_rsip_func_sub025(0x00020061U, 0x40000000U, 0x0900890eU);
        WR1_PROG(REG_1408H, 0x000c1000U);
    }
    else if (RD1_MASK(REG_1440H, 0xffffffffU) == 0x00000004U)
    {
        ...
        r_rsip_func_sub025(0x00020061U, 0x40000000U, 0x07008d06U);
        WR1_PROG(REG_1408H, 0x000c1000U);
    }
    else
    {
