                       ...
                       uint32_t       KEY_INDEX_SIZE)
{
    ...
    else
    {
        ...
        r_rsip_func_sub003(0x800103a0U, 0x00009001U);
        ...
        else
        {
            ...
            r_rsip_func_sub003(0x800103a0U, 0x00009002U);
        ...
        else
        {
            ...
            {
                r_rsip_func_sub003(0x800103a0U, 0x00000090U);
                ...
                r_rsip_func_sub003(0x800103a0U, 0x00009003U);
                ...
                {
                    r_rsip_func_sub022(0x000008c6U, 0x34202bc7U, 0x2000d0c0U);
