...
rsip_ret_t r_rsip_p81 (void)
{
    ...
    else
    {
        ...
        {
            0x31abdad9U, 0xe2670818U, 0xa1798641U, 0xdfe2b0baU,
        };
        ...
        {
            0x62898deaU, 0x6230c402U, 0x7f8ae49dU, 0x1fd2fe86U,
        };
        r_rsip_func101(Param_p81_func101_002);

        static const uint32_t Param_p81_func100_001[] =
        {
            0x5eb18f89U, 0x06980d12U, 0x49433099U, 0xdc4d05f9U,
        };
        ...
        else
        {
            ...
            {
                0xd519a52aU, 0x9b8a8615U, 0xf5ec9053U, 0x62c65350U,
            };
