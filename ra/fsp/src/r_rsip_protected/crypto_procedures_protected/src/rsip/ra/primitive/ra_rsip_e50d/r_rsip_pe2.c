                       ...
                       uint32_t       OutData_EncSecret[])
{
    ...
    r_rsip_func_sub003(0x800103a0U, 0x0000e201U);
    ...
    else
    {
        ...
        else
        {
            ...
            r_rsip_func_sub003(0x800103a0U, 0x0000e202U);
        ...
        else
        {
            ...
            r_rsip_func_sub003(0x800103a0U, 0x000000e2U);
            ...
            else
            {
                ...
                r_rsip_func_sub003(0x800103a0U, 0x0000e203U);
