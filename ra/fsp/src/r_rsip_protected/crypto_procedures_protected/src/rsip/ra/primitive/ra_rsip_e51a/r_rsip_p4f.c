                       ...
                       uint32_t       OutData_EncSecret[])
{
    ...
    r_rsip_func_sub030(0x004f0001U, 0x000007f0U);
    ...
    r_rsip_func_sub003(0x000000a7U, 0x800103a0U, 0x00004f01U);
    ...
    else
    {
        ...
        if (CHCK_STS(REG_143CH, 22, 1))
        {
            ...
            r_rsip_func_sub039(0x00000bffU, 0x00000bbdU);

            for (iLoop = 0U; iLoop < 2U; iLoop++)
            {
                for (jLoop = 0U; jLoop < 3U; jLoop++)
                {
                    r_rsip_func_sub024(0x0000381eU, 0x38000c00U, 0x100053fdU, 0x00002fa0U);
                    WR1_PROG(REG_1600H, 0x0000a7c0U);
                    WR1_PROG(REG_1600H, 0x00000004U);
                }

                WR1_PROG(REG_1458H, 0x00000000U);
                r_rsip_func_sub024(0x0000381eU, 0x38008c00U, 0xfffffe00U, 0x100053fdU);

                r_rsip_func_sub025(0x00002fa0U, 0x0000b7c0U, 0x00000050U);
            }
        ...
        else
        {
            ...
            r_rsip_func_sub003(0x000000a7U, 0x800103a0U, 0x00004f02U);
        ...
        else
        {
            ...
            r_rsip_func_sub003(0x000000a7U, 0x800103a0U, 0x0000004fU);
            ...
            else
            {
                ...
                r_rsip_func_sub003(0x000000a7U, 0x800103a0U, 0x00004f03U);
                ...
                r_rsip_func_sub040(0x40000200U, 0xe7009d07U, 0x12580000U);
