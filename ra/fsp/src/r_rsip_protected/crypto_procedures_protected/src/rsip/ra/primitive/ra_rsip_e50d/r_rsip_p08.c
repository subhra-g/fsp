...
rsip_ret_t r_rsip_p08 (uint32_t OutData_KeyIndex[])
{
    ...
    r_rsip_func_sub003(0x800103a0U, 0x00000801U);
    ...
    r_rsip_func_sub003(0x800103a0U, 0x00000008U);
    ...
    r_rsip_func_sub003(0x800103a0U, 0x00000802U);
    ...
    r_rsip_func_sub003(0x800103a0U, 0x00000803U);
