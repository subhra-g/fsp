...
[FSP v6.5.1](https://github.com/renesas/fsp/releases/tag/v6.5.1)
...
1.	Download the FSP with e² studio Installer from the Assets section of the [current release](https://github.com/renesas/fsp/releases/tag/v6.5.1).
